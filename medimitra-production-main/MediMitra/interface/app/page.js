  ...
  return (
		<div className="bg-[url('/bg.svg')] bg-cover min-h-screen flex flex-col overflow-x-hidden">
			...
			<main className="w-full flex flex-col items-center  relative">
				<h1
					id="animated-h1"
					className="text-4xl font-dm text-white tracking-tight md:text-7xl lg:text-[12rem] font-bold text-center mt-5"
				>
					Medication
				</h1>
				<h1
					id="animated-h1"
					className="text-4xl font-dm text-white tracking-tight md:text-7xl lg:text-9xl mb-12 font-bold text-center"
				>
				Made Easy
				</h1>
				...
				<p
					id="hero-description"
					className="text-center text-white font-light font-inter text-lg md:text-xl lg:text-2xl mb-5 leading-relaxed md:leading-relaxed lg:leading-relaxed"
				>
